...
namespace Blueberry.Desktop.WindowsApp.Bluetooth
{
    ...
    public class DnaBluetoothLEAdvertisementWatcher
    {
        ...
        /// </summary>
        private readonly GattServiceIds mGattServiceId;
        ...
        /// </summary>
        public DnaBluetoothLEAdvertisementWatcher(GattServiceIds gattIdd)
        {
            // Null guard
            mGattServiceId = gattIdd ?? throw new ArgumentNullException(nameof(gattIdd));
        ...
        /// <param name="broadcastTime">The time of the broadcast message was received</param>
        ...
        private void CleanupTimeouts()
        {
            lock (mThreadLock)
            {
                // The date and time that if less than means a device has timed out
